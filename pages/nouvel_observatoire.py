...
1. Tout d'abord, recherchez ces types d'entités dans le texte et générez-les dans un format séparé par des virgules, similaire à celui des types d'entités. La propriété `id` de chaque entité doit être alphanumérique et unique parmi les entités. Vous ferez référence à cette propriété pour définir la relation entre les entités. Ne créez pas de nouveaux types d'entités qui ne sont pas mentionnés ci-dessous. Le document doit être résumé et stocké dans l'entité Article sous la propriété `description`. Vous devrez générer autant d'entités que nécessaire selon les types ci-dessous :
    ...
    label:'TypeEvenement',type:string //TypeEvenement c'est le type d'événement qui s'est produit
    ...
    label:'Facteur',name:string // Entité Facteur c'est le facteur explicatif de l'événement; la propriété `name` c'est le nom du facteur, en lowercase & camel-case & qui commence toujours par un caractère alphabétique
    label:'Solution',name:string,description:string,when:string // Entité Solution c'est la solution qui pourrait aider à résoudre l'événement qui s'est produit ; la propriété `name` c'est le nom du facteur, en lowercase & camel-case & qui commence toujours par un caractère alphabétique
    label:'Impact',name:string,description:string // Entité Impact c'est l'impact de l'événement qui s'est produit ; la propriété `name` c'est le nom de l'impact, en lowercase & camel-case & qui commence toujours par un caractère alphabétique
    ...
    label:'Groupe',nom:string,nature:string,nombreMembres:integer // Entité Groupe c'est un groupe auquel une personne est liée ; la propriété `name` c'est le nom du groupe, en lowercase & camel-case & qui commence toujours par un caractère alphabétique
